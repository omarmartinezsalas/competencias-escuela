...
<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 contenido">
	<h1>Edita perfil</h1>
		...
		<!--<form id="formf" action="../controller/controller_profesor.php?accion=foto" enctype="multipart/form-data" method="post">
			...
			entradas_datos_a($_SESSION['clave']);
			...
			<form name="contra" method="post" action="../controller/controller_profesor.php?accion=pass">
				...
				echo "<input type='hidden' value='".$_SESSION['clave']."' name='clave'></input>";
				?>
				<center><label>Contraseña actual: <input type="password" class="form-control form-control-lg" name="actual" id="original"></input></label><br>
				<label id="origin" style="color:red;"></label><br><br><br>
				<label>Nueva contraseña: <input id="pass" type="password" class="form-control form-control-lg" name="nueva"></input></label><br>
				<label id="mcontra" style="color:red;"></label><br>
				<label>Repite nueva contraseña: <input id="pass2" type="password" class="form-control form-control-lg" name="confirma"></input></label><br>
